...
class PipelineEthInterceptEvent(feed:String,output:String,interceptor:Interceptor[Event])(implicit config:Config) extends PipelineEthIntercept[Event](feed,output,interceptor)(config) {
