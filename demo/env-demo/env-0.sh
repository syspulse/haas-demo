...
export SMTP_USER=
export SMTP_PASS=
export SMTP_FROM=no-reply@syspulse.io
...
export NOTIFY_EMAIL=haas@syspulse.io
...
export ETH_AUTH_CLIENT_ID="eaf9642f76195dca7529c0589e6d6259"
export ETH_AUTH_CLIENT_SECRET="vn5digFyJVZCIVLExNo_Hynz0zDxEUDRlu5FHB9Qvj8"
