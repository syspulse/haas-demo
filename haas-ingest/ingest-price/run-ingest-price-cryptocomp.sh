...
./run-ingest-price.sh --ingest.cron=3600 -e cryptocomp -f cryptocomp:// --tokens=file://token-set-default.conf --delimiter= -o fs3:///mnt/s4/data/dev/cryptocomp/raw/csv/price/{yyyy}/{MM}/{dd}/price-{HH}_{mm}_{ss}.csv