...
case class EthTokenTransfer(tokenAddress:String,from:String,to:String,value:BigInt,txHash:String,logIndex:Int,blockNumber:Long,blockTimestamp:Long) extends Ingestable
...
object EthEtlJson extends JsonCommon with NullOptions {
  ...
  implicit val jf_tt = jsonFormat(EthTokenTransfer,"token_address","from_address","to_address","value","transaction_hash","log_index","block_number","block_timestamp")
