...
class PipelineEthInterceptTokenTransfer(feed:String,output:String,interceptor:Interceptor[TokenTransfer])(implicit config:Config) extends PipelineEthIntercept[TokenTransfer](feed,output,interceptor) {
