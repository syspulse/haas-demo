...
class PipelineEthIntercept(feed:String,output:String,interceptor:Interceptor)(implicit config:Config) extends PipelineEth[Tx,Interception](feed,output) with EthTx {
